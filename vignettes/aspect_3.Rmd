...
predictions. However, the above figure raises a further issue, in that the
...
The $\rho$ with the negatives corrected is unintuitively very slightly lower
...
showing a good correspondance, as given by the correlation coefficient of
`r pbsEDM_rho_Y`.

Thus, a good correspondance based on the first-differenced $Y_t$ values does not
necessarily lead to good correspondance in the $N_t$ values, which is what we
are interested in for practical situations.
