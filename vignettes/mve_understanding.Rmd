...
response_s_predicted <- response_s[prediction_indices]
...
NEXT HERE: Need to untransform, but `untransform_variables()` needs to be
updated to un-first difference also.Can check it works for original.
