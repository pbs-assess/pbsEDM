...
called repeatedly by `mve()` to do all of them.

Not sure how $E$ gets prescribed, though could loop over it. In `mve()` looks
...
`R_prime_t`, just want to be able to switch.:
...
# well. So you shouldn't use R_prime_t for both, presumably.
