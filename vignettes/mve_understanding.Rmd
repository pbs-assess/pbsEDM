...
HERE HERE HERE. This fails - see browser() in function. Fails for S_t with lag
of 2; need to repeat the fix I just did, have to disallow max_lag -ish candidate
nearest neighbours at the
end that have undefined projections. See TODO in state_space_distances_for_sve().
