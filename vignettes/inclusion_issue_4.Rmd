...
index is within  exclusionRadius." I originally thought that this
isn't quite what we want since goes both ways, but the time steps
ahead should be excluded anyway so maybe it is (I just haven't worked
through it until now). First try setting it to 1
```{r exclusion1}
# TODO do here then do in data-raw and save
check_rEDM_excl_1 <- rEDM::Simplex(dataFrame = input,
                                   columns = "Y_t",
                                   target = "Y_t",
                                   lib = "1 99",
                                   pred = "1 99",
...
```{r exclusion2}
# TODO do here then do in data-raw and save
check_rEDM_excl_2 <- rEDM::Simplex(dataFrame = input,
                                   columns = "Y_t",
                                   target = "Y_t",
                                   lib = "1 99",
                                   pred = "1 99",
