...
$\rho$, and so is best used for forecasting $N_{101}$. This is given by:
...
In this case we obtain a negative forecast for $N_{101}$ (which is explored as Aspect 3).
...
neighbour from the library that would get used as a nearest neighbour if not
removed (Aspect 2):
...
<!-- ![pbsEDM_movie_tstar_9.gif](pbsEDM_movie_tstar_99.gif). -->
