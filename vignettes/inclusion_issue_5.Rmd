...
my_pred_N <- c(NA,
               N_t + my_pred_Y)
# Can't predict N[3] since can't predict know Y_2 since can't use t^*=1 as focal point

# Commenting out to build vignette, but needs figuring out.
