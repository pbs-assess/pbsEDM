...
calculations here for $E=3$, which is the embedding dimension selected for use
by the EDM calculations. The code is available in the vignette code but not all
of it is shown here. The first-differencing calculations remain the same, the higher embedding
